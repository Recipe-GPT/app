...
import ChatDetailRecipe from "../ChatDetailRecipe";
      ...
      <CS.ChatSection>
        <CS.ChatWrap>
          <CS.ContentWrap>
            ...
            <S.RecipeList>
              <ChatDetailRecipe index={1} title="김치 감자 피망 돼지고기 볶음">
                감자와 피망을 굵게 썬 후 돼지고기와 함께 볶은 뒤 김치를 넣고
                볶아줍니다.
              </ChatDetailRecipe>
              <ChatDetailRecipe index={2} title="돼지고기 김치 찌개">
                돼지고기와 김치를 함께 끓여 매운 김치찌개를 만듭니다. 감자와
                피망을 넣어 더욱 맛을 높일 수 있습니다.
              </ChatDetailRecipe>
              <ChatDetailRecipe index={3} title="김치 감자 피망 돼지고기 전">
